...
export default function TaskForm({ statuses, task, method, children = 'Form' }) {
    ...
    return (
        <div className='task-details__container'>
            <h1 className="task-details__title">{children}</h1>
            <Form className="task-details" method={method} ref={formRef} onKeyDown={handleKeyDown}>
                <div className='task-details__fields'>
                    <input
                        id="title"
                        name='title'
            ...
            {isSubmitting ? (
                ...
                <button type="button" onClick={handleSave} className="task-details__button task-details__button--save">
            ...
            {!isSubmitting && task && (
                <button type="button" onClick={() => handleDelete(task.id)} className="task-details__button task-details__button--delete">
